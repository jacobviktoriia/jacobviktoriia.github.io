document.addEventListener('DOMContentLoaded', function() {
  ...
  const translations = {
    en: {
      ...
      milestone2Text: "We'll meet in person to gather proof of our marriage for visa purposes. We have not seen each other in almost a year!",
    ...
    ru: {
      // Header
      headerTitle: "Яков и Виктория",
      headerSubtitle: "Мы женимся!",
      
      // Navigation/Intro
      ourJourney: "Наша История",
      introText1: "Привет! Это <strong>Яков</strong> и <strong>Виктория</strong>. Пожалуйста, нажмите \"Включить музыку\" в правом нижнем углу, чтобы насладиться этим моментом вместе с нами!",
      ...
      milestone2Text: "Мы встретимся лично, чтобы собрать доказательства нашего брака для визовых целей. Мы не видели друг друга почти год!",
